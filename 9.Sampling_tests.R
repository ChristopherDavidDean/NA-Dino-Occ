...
################################################################################
#             FILE 9: TESTING IMPACT OF RANDOM SAMPLING ON RESULTS             #
################################################################################
...
Ests <- purrr::map2(Ests, names(Ests), ~ mutate(.x, Samp = gsub(".*?([0-9]+).*", "\\1", .y)))
Param <- purrr::map2(Param, names(Param), ~ mutate(.x, Samp = gsub(".*?([0-9]+).*", "\\1", .y)))
...
Ests2 <- purrr::map2(Ests2, names(Ests2), ~ mutate(.x, Samp = gsub(".*?([0-9]+).*", "\\1", .y)))
Param2 <- purrr::map2(Param2, names(Param2), ~ mutate(.x, Samp = gsub(".*?([0-9]+).*", "\\1", .y)))
